package finalreview.preonlinetest.Q3_version_students;
...
public class RBTree<T extends Comparable<T>> {
	...
	public boolean testProp2() {
		...
		return root.satisfyProp2(); //you are allowed to change this return statement
		// END YOUR CODE
	}
	...
	public class Node<E extends Comparable<E>> {
		...
		public boolean satisfyProp1() {
			if (parent == null && colour == Colour.RED) {
				return false;
			}
			if (value == null) {
				return colour == Colour.BLACK;
			}
			return left.satisfyProp1() && right.satisfyProp1();
		}

		public boolean satisfyProp2() {
			if (value == null) {
				return true;
			}
			if (colour == Colour.RED) {
				if (left.colour != Colour.BLACK || right.colour != Colour.BLACK) {
					return false;
				}
			}
			return left.satisfyProp2() && right.satisfyProp2();
		}
