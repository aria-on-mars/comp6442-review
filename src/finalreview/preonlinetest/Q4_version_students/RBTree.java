package finalreview.preonlinetest.Q4_version_students;//import java.util.ArrayList;
...
public class RBTree<T extends Comparable<T>> {
	...
	public boolean testProp3() {
		...
		return root.testProp3(); //you are allowed to change this return statement
		// END YOUR CODE
	}
	...
	public class Node<E extends Comparable<E>> {
		...
		public boolean testProp3() {
			int numberBlackNode = getNumberOfBlack();
			return validatePathBlackNode(numberBlackNode);
		}

		public int getNumberOfBlack() {
			int numberBlackNode = 1;
			Node targetNode = this;
			while (targetNode.value != null) {
				if (targetNode.colour == Colour.BLACK) {
					numberBlackNode++;
				}
				targetNode = targetNode.left;
			}
			return numberBlackNode;
		}

		public boolean validatePathBlackNode(int numberBlackNode) {
			if (colour == Colour.BLACK) {
				numberBlackNode--;
			}
			if (value == null) {
				return numberBlackNode == 0;
			}
			return left.validatePathBlackNode(numberBlackNode) && right.validatePathBlackNode(numberBlackNode);
		}
